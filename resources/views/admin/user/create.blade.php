                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action={{ route('admin.user.store') }} method='post'>
                            ...
                            <div class="form-group row mb-3">
                                <label for="password-confirm" class="col-md-4 col-form-label text-md-right">Επιβεβαίωση
                                    κωδικού</label>
                            ...
                            <div class="form-group row mb-3">
                                <label for="password-reset" class="col-md-4 form-check-label text-md-right">Αλλαγή του
                                    κωδικού μετά την πρώτη είσοδο</label>

                                <div class="col-md-6">
                                    <input id="password-reset" type="checkbox" class="form-check-input"
                                        name="password_reset" value="1" checked>
                                </div>
                            </div>
