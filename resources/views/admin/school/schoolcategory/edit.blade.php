        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.school.schoolcategory.update', $schoolcategory->id) }}" method='post'>

                    <div class="form-group row mb-3">
                        <label for="name" class="col-md-4 col-form-label text-md-right">Όνομα</label>

                        <div class="col-md-6">
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $schoolcategory->name }}" required autocomplete="name" autofocus>
