                    ...
                    <div class="card-body">
                        ...
                        @else
                            ...
                            <form action={{ route('admin.school.store') }} method='post'>
                                ...
                                <div class="form-group row mb-3">
                                    <label for="code" class="col-md-4 col-form-label text-md-right">Κωδικός Σχολικής
                                        Μονάδας</label>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <pillbox :options="{{ json_encode($categories) }}" name="category"
                                            @if (old('category')) value="{{ old('category') }}" @endif
                                            test-data-id="select-category">
                                        </pillbox>
