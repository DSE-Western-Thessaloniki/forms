            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action={{ route('admin.accepted_filetype.update', $accepted_filetype) }} method='post'>
                            @method('PUT')
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="description" type="text"
                                        ...
                                        value="{{ $accepted_filetype->description }}" required autocomplete="description" autofocus required>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="extension" type="text"
                                        ...
                                        value="{{ $accepted_filetype->extension }}" required autocomplete="extension" autofocus required>
