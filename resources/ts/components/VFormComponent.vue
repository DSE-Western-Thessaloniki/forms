    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                                ...
                                >
                                    ...
                                    >
                                        <vform-field-component
                                            ...
                                            v-on:deleteField="delField"
                                            ref="vform_fields"
                                            :restricted="
                                                restricted && !element.new_field
                                            "
                                            :no_drag="restricted"
                                            :required="
                ...
                <div class="card mt-5">
                    <div class="card-header">Διαθέσιμη σε</div>
                    <div class="card-body">
                        <div class="form-check">
                            <input
                                class="form-check-input"
                                type="radio"
                                name="for_teachers"
                                id="radio_for_teachers1"
                                value="1"
                                v-model="for_teachers"
                            />
                            <label
                                class="form-check-label"
                                for="radio_for_teachers1"
                            >
                                Εκπαιδευτικούς
                            </label>
                        </div>
                        ...
                        <div class="form-check">
                            <input
                                ...
                                type="radio"
                                name="for_teachers"
                                id="radio_for_teachers2"
                                value="0"
                                v-model="for_teachers"
                            />
                            <label
                                class="form-check-label"
                                for="radio_for_teachers2"
                            >
                                Σχολικές μονάδες
                            </label>
                        </div>
                        ...
                        >
                            <li class="list-group-item">
                                <div class="row">
                                    <label for="categories" class="m-2"
                                        >Κατηγορίες:</label
                                    >
                                    <pillbox
                                        class="flex-fill"
                            ...
                            <li class="list-group-item">
                                <div class="row">
                                    <label for="schools" class="m-2"
                                        >Σχολικές μονάδες:</label
                                    >
                                    <pillbox
                                        class="flex-fill"
...
let notes = ref("");
let fields: Ref<Array<App.Models.FormField>> = ref([
